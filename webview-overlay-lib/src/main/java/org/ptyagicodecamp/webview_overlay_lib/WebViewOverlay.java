...
import org.ptyagicodecamp.webview_overlay.BuildConfig;
...
public class WebViewOverlay implements WebViewOverlayAPI {
     ...
     * @return
     * @throws WebViewOverlayException
     */
    protected String getUrl(String baseUrl, HashMap<String, String> params) throws WebViewOverlayException {
