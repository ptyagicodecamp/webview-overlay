...
import org.ptyagicodecamp.webview_overlay.R;
...
public class WebViewHelper implements View.OnClickListener {
    ...
    public void openWebViewInOverlay(String url, String popupTitle) throws WebViewOverlayException {
        ...
        View view = inflater.inflate(R.layout.webview_modal, null);
        Button closeSurvey = (Button) view.findViewById(R.id.closeSurvey);
